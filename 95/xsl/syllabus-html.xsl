...
<xsl:template match="webwork-reps//hint|webwork-reps//solution" mode="structure-number">
    <xsl:apply-templates select="ancestor::exercise" mode="number" />
</xsl:template>

<xsl:template match="webwork-reps//stage/hint|webwork-reps//stage/solution" mode="structure-number">
    <xsl:apply-templates select="ancestor::exercise" mode="number" />
</xsl:template>
